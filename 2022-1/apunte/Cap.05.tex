...
\begin{proof} \ref{item:hierholzer_a}
    ...
    \ref{item:hierholzer_b} Saliendo del vértice original,  cada vez que ingresamos a un vértice de valencia par tenemos aristas sin usar y salimos por alguna de ellas. Por lo tanto, no es posible quedarse atascado en ningún vértice que sea par y el recorrido maximal debe terminar en un vértice impar. Pero no puede terminar en el vértice original, pues si terminara ahí el vértice sería par. Todo esto implica que el recorrido maximal termina en el vértice impar que no es el origen. 
\end{proof}
