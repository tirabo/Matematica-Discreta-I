...
\end{equation*}
Por la propiedad transitiva de ``congruencia módulo $m$'', $ r \equiv s \pmod{m}$, luego $m | r-s$.  Podemos suponer, sin perdida de generalidad, que $s \le r$, luego $0\le r-s< m$, lo cual implica que $r-s=0$,  es decir $r=s$. 
