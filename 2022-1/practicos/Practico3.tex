...
\item Calcular el máximo común divisor y el mínimo común múltiplo de los siguientes pares de números usando la descomposición en números primos. 
    \begin{enumerate}
    \begin{minipage}{0.40 \textwidth}
        \item $a=12$ y $b=15$. \end{minipage}
        \begin{minipage}{0.40 \textwidth}
        \item$a=11$ y $b=13$.\end{minipage}
        
        \begin{minipage}{0.40 \textwidth}
        \item $a=140$ y $b=150$.\end{minipage}
        \begin{minipage}{0.40 \textwidth}
        \item $a=3^2 \cdot 5^2$ y $b=2^2 \cdot 11$.\end{minipage}
        
        \begin{minipage}{0.40 \textwidth}
        \item $a=2^2 \cdot 3\cdot 5$ y $b=2\cdot 5\cdot 7$.\end{minipage}
    \end{enumerate}
