...
\date[05/04/2022]{5 de abril  de 2022}
...
\begin{frame}\frametitle{Problemas de conteo}     
    ...
    \begin{itemize}
        \item ¿Cuántas chapas patente  es posible hace con el actual esquema de numeración? Nos referimos a las patentes de automóviles en Argentina.  \pause
        \item ¿De cuantas formas se pueden sentar 7 personas en un colectivo de 20 asientos?
    \end{itemize}
    \pause
    \vskip .4cm
