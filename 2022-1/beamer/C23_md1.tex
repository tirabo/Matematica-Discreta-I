...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Sin embargo hay un método simple de hacer una coloración usando un  ``razonable'' número de colores.
        \end{itemize}
...
\begin{teorema}\label{t5.7.1} Si $G$ es un grafo con valencia máxima
    ...
    \begin{frame}
        ...
        \vskip .4 cm
        \ref{it.com_b}       
            (1) Sea $v_n$ un vértice con $\delta(v_n) < k$. 
            \vskip .2 cm
            (2) Sean $v_{n-1},v_{n-2},\ldots,v_{n-r}$ los adyacentes a $v_n$. Hay a lo más $k-1$ de ellos.
            \vskip .2 cm
            (3) Luego se van eligiendo los adyacentes a $v_i$  que no están listados antes ($n > i \ge 1$). 
            \vskip .2 cm
            ...
            \vskip .2 cm
            (5) Si $i < n$, usando greedy y por (4),  se puede colorear $v_i$ con un color en $\{1,\ldots,k\}$.
            \vskip .2 cm
            (6) Por (2) se puede colorear $v_n$   on un color en $\{1,\ldots,k\}$.\qed
...
\end{ejemplo}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Elijamos cualquier vértice y llamémoslo $v_1$; diremos que $v_1$ esta en el \textit{nivel $0$}. 
            \vskip .2cm
            \item A continuación, listemos la lista de vecinos de $v_1$, llamémoslos $v_2,v_3, \dots,v_r$; diremos que estos vértices están en el \textit{nivel 1}. 
            \vskip .2cm
            \item Continuando de esta manera, definimos el \textit{nivel $i$} como todos aquellos vértices adyacentes a los del {nivel $i-1$}, exceptuando aquellos previamente listados en el {nivel $i-2$}. 
        \end{itemize}
    ...
    \begin{frame}
        ...
        \vskip .4cm
        \begin{itemize}
            \item el color $1$ a los vértices en el nivel $0,2,4,\ldots$,
            \vskip .2cm
            \item el color $2$ a los vértices en los niveles $1,3,5,\ldots$.
        \end{itemize}
        \vskip .4cm
