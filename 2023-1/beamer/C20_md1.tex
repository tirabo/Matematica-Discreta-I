...
\title[Clase 20 - Caminatas eulerianas]{Matemática Discreta I \\ Clase 20 - Caminatas eulerianas, ciclos hamiltonianos}
%\author[C. Olmos / A. Tiraboschi]{Carlos Olmos / Alejandro Tiraboschi}
\institute[]{\normalsize FAMAF / UNC
    \\[\baselineskip] ${}^{}$
    \\[\baselineskip]
}
\date[08/06/2023]{8 de junio de 2023}
...
\begin{document}
    ...
    \begin{frame}
        ...
        Artículo: \href{https://eudml.org/doc/156599}{Ueber die Möglichkeit, einen Linienzug ohne Wiederholung und ohne Unterbrechung zu umfahren}. Mathematische Annalen volume 6, pp. 30–32 (1873) (en alemán). \pause
    ...
    \begin{frame}\frametitle{Algoritmo de Hierholzer: idea clave}\pause
        ...
        La idea clave del algoritmo de Hierholzer  es la siguiente:  en un grafo de valencias pares (conexo o no conexo) todo recorrido maximal termina en el vértice original. Veamos la demostración de esta afirmación.
        ...
        \begin{itemize}
            ...
            \item Como $\delta(v)$  es par,  si $v\ne x$ cada vez que ingreso y salgo  de $v$ me queda un un número par de aristas de ese vértice sin utilizar.\pause
