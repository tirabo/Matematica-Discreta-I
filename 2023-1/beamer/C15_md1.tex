...
\begin{document}
    ...
    \begin{frame}
        \begin{proof}
            ...
            \begin{itemize}
                \item $m | x_1 -x_2$, multiplicando por $y_1$ $\Rightarrow$ $m | x_1y_1-x_2y_1$.
                \item $m | y_1 -y_2$, multiplicando por $x_2$ $\Rightarrow$ $m | x_2y_1-x_2y_2$.
            \end{itemize}
            Luego
            \begin{itemize}
                \item  $m | (x_1y_1-x_2y_1) + (x_2y_1-x_2y_2) = x_1y_1-x_2y_2$.
            \end{itemize}
            Por lo tanto,
            $$
...
\end{comment}
    ...
    \begin{frame}
        ...
        \begin{proof} Si probamos con los enteros $x$ tal que  $0\le x < 11$, veremos que la ecuación admite una única solución en ese rango, a saber $x=6$. 
            \vskip .2cm\pause
            
            Otras soluciones se obtienen tomando $6+11k$, pues \pause 
            $$
            3(6+11k) \equiv  18+3\cdot 11k \equiv 7+3\cdot 0\cdot k\equiv 7 \pmod{11}.
            $$
        Sea $x$ tal que $3x\equiv 7  \pmod{11}$.  Veremos que $x$ es de la forma $6+11k$.
        \vskip .2cm\pause
        Ahora bien, por algoritmo de división, $x = 11k + r$, con $0 \le r < 11$. Luego
        $$
        7 \equiv 3x \equiv 3\cdot 11k + 3r \equiv 3r \pmod{11}.
        $$
        Como $0 \le r < 11$ $\Rightarrow$ $r=6$.\qed
    ...
    \begin{frame}
        ...
        Pero $140>109$. Ahora bien,  $31 = 140 -109$ también  es solución, pues \linebreak $109 \equiv 0\pmod{109}$. 
        \vskip .3cm
