...
\end{ejemplo}
    ...
    \end{frame}
        ...
        \vskip .2cm
        Así bajamos de nivel hasta que esta sucesión de adyacencias termina en el  vértice $v_1$ del nivel 1.
        \vskip .2cm\pause 
        Sea $z$ el primer vértice común en esta sucesión de adyacencias. \pause
        \vskip .2cm
        Entonces los vértices $x$, $y$ son unidos por caminos de igual longitud $m$ a algún vértice $z$ de un nivel anterior.\pause 
        \vskip .2cm
