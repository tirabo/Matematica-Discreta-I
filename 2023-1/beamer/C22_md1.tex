...
\end{ejemplo}
    ...
    \end{frame}
        ...
        Supongamos que $x$ e $y$ son vértices en el mismo nivel $i$.\pause
        \vskip .2cm
        Entonces $x$ e $y$ son adyacentes a vértices $x_{i-1}$, $y_{i-1}$, respectivamente,  del nivel $i-1$.\pause
        \vskip .2cm
        A su vez, estos vértices del nivel $i-1$ son adyacentes a vértices $x_{i-2}$, $y_{i-2}$, respectivamente, del nivel $i-2$.\pause
        \vskip .2cm
        Así bajamos de nivel hasta que esta sucesión de adyacencias termina en el  vértice $v_1$ del nivel $0$.
        \vskip .2cm\pause 
        Sea $z$ el primer vértice común en esta sucesión de adyacencias y sea $m$ el nivel donde se encuentra $z$. \pause
        \vskip .2cm
        Entonces, los vértices $x$, $y$ son unidos por caminos longitud $m$ al vértice $z$.\pause 
        \vskip .2cm
