...
\begin{document}
	...
	\begin{frame}
		...
		{\color{blue}Ejercicio}
		\vskip .2cm
		¿De cuántas formas diferen 		distintas (etiquetadas) de forma que cada urna contenga una bola? Es decir en  cada urna una bola.
		\vskip .2cm \pause
		{\color{blue}Solución.}
		\vskip .2cm
	...
	\begin{frame}
        ...
        {\color{blue}Observación} Este problema es equivalente a ``cuantas permutaciones de 5 blancas, 3 rojas y 2 negras''. Como resolvíamos problemas similares, podemos pensar primero que toda las bolas tienen distinto color,  con lo cual tenemos $10!$ permutaciones.
        \vskip .2cm
        Luego,  hay que dividir por las permutaciones de dos bolas blancas, 3 rojas  y 2 negras, y el resultado es
