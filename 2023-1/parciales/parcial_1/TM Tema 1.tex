...
\centerline{\textbf{\large{Turno Mañana - Tema 1}}}
...
\noindent{\bf COMISIÓN (tal como figura en Guaraní):} 
 ...
 \begin{enumerate}
        \item (10 \%) Dada la siguiente definición recursiva:
            $$
            c_1 = 2, \qquad c_2 = -1, \qquad c_n = 4c_{n-1} -2c_{n-2}, \text{ para $n\geq 3$},
            $$
       ...
       \item  (15 \%) Demostrar por inducción 
        ...
        \item  ({25 \%})
         Sea $\{a_n\}_{n\in\mathbb N_0}$ la sucesi\'on definida recursivamente por
            $$\begin{cases}
            a_0=4, \\a_1=15, \\a_{n} = 6a_{n-1}-9a_{n-2}, \text{ para $n\geq 2$}.
            \end{cases}$$
            \vspace{0.3cm}
            Probar que $a_n= n \,3^n + 4\cdot 3^n$ para todo $n\in \mathbb N_0$.
   \end{enumerate}
\medbreak
        \item (15\%) ¿Cuántas palabras distintas pueden formarse con las letras de la palabra\newline  PARECEREMOS?
\medbreak
        \item En una veterinaria hay $16$ cobayos, $9$ perros cachorros, $21$ ardillas,  y $14$ lagartijas. Queremos elegir un total de $5$ mascotas. ¿De cuántas formas podemos hacerlo?
    
    \medbreak
    \begin{enumerate}
        \item (5\%) Si no hay restricciones. 
        \item (10\%) Si debe haber $3$ cobayos y $2$ ardillas.
        \item  (10\%) Si debe haber al menos $3$ cobayos.
