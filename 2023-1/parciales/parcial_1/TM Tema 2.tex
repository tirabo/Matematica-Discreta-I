...
\centerline{\textbf{\large{Turno Mañana - Tema 2}}}
...
\begin{enumerate}
            ...
            \item (10 \%) Dada la siguiente definición recursiva:
            $$
            c_1 = 4, \qquad c_2 = -1, \qquad c_n = 3c_{n-1} - 2c_{n-2}, \text{ para $n\geq 3$},
            $$
    ...
    \medbreak
        ...
        \begin{enumerate}
            ...
            $$
            \sum_{i = 1}^n  \frac{2}{i(i+1)} = \frac{2n}{n+1} \,.
            $$
            \item ({25 \%})
        Sea $\{a_n\}_{n\in\mathbb N_0}$ la sucesi\'on definida recursivamente por
            $$\begin{cases}
                a_1=5, \\a_2=13, \\a_{n} = 5a_{n-1}-6a_{n-2}, \text{ para $n\geq 3$}.
            \end{cases}$$
            \vspace{0.3cm}
            Probar que $a_n= 2^n + 3^n$ para todo $n\in \mathbb N$.
        \end{enumerate}
...
\medbreak
        \item En una veterinaria hay $10$ cobayos, $6$ perros cachorros, $8$ ardillas,  y $13$ lagartijas. Queremos elegir un total de $5$ mascotas. ¿De cuántas formas podemos hacerlo?
    
    \medbreak
    \begin{enumerate}
        \item (5\%) Si no hay restricciones. 
        \item (10\%) Si debe haber $3$ cobayos y $2$ ardillas.
        \item  (10\%) Si debe haber al menos $2$ cobayos.
        \item (10\%) Si debe haber al menos un animal de cada clase,  es decir debe haber al menos un cobayo, un perro cachorro, una ardilla y  una lagartija.
    \end{enumerate}
\end{enumerate}
\vskip .8cm
\begin{center}
