...
\centerline{\textbf{\large{Turno Tarde - Tema 2}}}
...
\begin{enumerate}
            ...
            $$
            c_1 = 5, \qquad c_2 =-1, \qquad c_n = 2c_{n-1} - 4c_{n-2}, \text{ para $n\geq 3$},
            $$
       ...
       \item \begin{enumerate}
            \item  ({25 \%})
             Sea $\{a_n\}_{n\in\mathbb N_0}$ la sucesi\'on definida recursivamente por
                $$\begin{cases}
                a_1=7, \\a_2=29, \\a_{n} = 5a_{n-1}-6a_{n-2}, \text{ para $n\geq 3$}.
                \end{cases}$$
                \vspace{0.3cm}
                Probar que $a_n= 5 \cdot 3^n -4\cdot2^n$ para todo $n\in \mathbb N$.
       \item  (15 \%) Demostrar por inducción 
            $$
            \sum_{i = 2}^n  \frac{2}{i(i-1)} = \frac{2(n-1)}{n} \,.
            $$
        \end{enumerate}
\medbreak
 
        \item (15\%) ¿Cuántas palabras distintas pueden formarse con las letras de la palabra\newline  TERRATENIENTES?
\medbreak
        \item En un campo hay $20$ vacas, $12$ perros, $8$ gatos,  y $35$ gallinas. Queremos elegir un total de $5$ animales para fotografiar. ¿De cuántas formas podemos hacerlo?
    
    \medbreak
    \begin{enumerate}
        \item (5\%) Si no hay restricciones. 
        \item (10\%) Si debe haber $10$ vacas y $4$ perros.
        \item  (10\%) Si debe haber al menos $5$ gallinas.
