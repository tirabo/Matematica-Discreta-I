...
\item Encuentre una función  del grafo $A$ al $B$ que preserve valencias. ¿Puede ser un isomorfismo?.
\vskip .2cm
    \begin{tabular}{llll}
        $A:$ & &\qquad$B:$& \\
        &
    ...
    \begin{enumerate}
        \item Probar que los  siguientes grafos no son isomorfos.
            ...
            \begin{center}
                ...
                \end{tabular}
            \end{center}
        \item En el grafo de la derecha del ítem anterior, encontrar un \textit{circuito euleriano}, es decir una caminata euleriana que comienza y termina en un mismo vértice.    
    \end{enumerate}
