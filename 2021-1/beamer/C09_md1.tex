...
\date[15/04/2021]{15 de abril  de 2021}
...
\begin{document}
	...
	\begin{frame}
		...
		\vskip .2cm
		Los coeficientes binomiales que intervienen en la fórmula de $(a+b)^n$ forman una fila del triángulo de Pascal:
		\begin{align*}
	...
	\begin{frame}
		...
		\vskip .2cm 
		\pause
		{\color{blue}2.} Los subconjuntos de un conjuntos son los subconjuntos de 0  elementos, unión los subconjuntos de $1$ elemento, unión los subconjuntos de $2$ elementos, unión los subconjuntos de $3$ elementos, etc.
	...
	\begin{frame}\frametitle{Ejercicios de conteo}
		...
		\end{enumerate} 
		\vskip .2cm
		\textbf{Total:} $9 +81+ 648+4536+27216 = 32490$.
	\end{frame}
	...
	\begin{frame}
		...
		{\color{blue}Solución.}
		\vskip .2cm
		Las cuarenta caretas son diferents y no nos importa el orden en que recibimos las cartas. 
		\vskip .2cm
		El problema es entonces elegir 5 entre cuarenta, por lo tanto la respuesta es
		\begin{equation*}
			\binom{40}{5}.
		\end{equation*}
		\vskip 2cm
