...
\begin{frame}
    ...
    El siguiente teorema nos da 4 nociones equivalente a la definición de árbol. 
...
\begin{frame}
    ...
    $$
    \textbf{T1} \quad \Rightarrow  \quad \textbf{T2} \quad \Rightarrow  \quad \textbf{T3} \quad \Rightarrow  \quad \textbf{T4} \quad \Rightarrow  \quad \textbf{T1}.
    $$
    ...
    $$
    \textbf{T1} \quad \Leftrightarrow \quad \textbf{T4}\qquad\text{pues} \qquad
    \left\{ 
    \begin{matrix*}[l]
        \textbf{T1} \quad \Rightarrow  \quad \textbf{T2} \quad \Rightarrow  \quad  \textbf{T3}  \quad \Rightarrow  \quad  \textbf{T4} \\
        \textbf{T4}  \quad \Rightarrow  \quad  \textbf{T1}. 
    \end{matrix*}    
    \right. 
    $$
...
\begin{frame}
    ...
    \begin{idea}
        ...
        \vskip .4cm
        (T2 $\Rightarrow$ T3) Sea $G' = T -uv$.  Como hay un único camino de $u$  a $v$,  $G'$ tiene dos componentes conexas: $T_1$  la componente conexa de $u$ y $T_2$ la componente conexa de $v$.
        \vskip .2cm
        ...
        \vskip .4cm
        (T3 $\Rightarrow$ T4) Se hace por inducción completa sobre el número de vértices y usando la porpiedad T3.
        \vskip .4cm
        (T4 $\Rightarrow$ T1)  $|E|=|V|-1$ y supongamos que $T$ no es árbol $\Rightarrow$ hay un ciclo $\Rightarrow$ podemos sacar una arista $uv$ y sigue siendo conexo   $\Rightarrow$ $|E -uv|=|V|-2$ y  conexo. Absurdo por el lema. 
