...
\title[Clase 19 - Grafos 1]{Matemática Discreta I \\ Clase 19 - Grafos 1}
%\author[C. Olmos / A. Tiraboschi]{Carlos Olmos / Alejandro Tiraboschi}
\institute[]{\normalsize FAMAF / UNC
	\\[\baselineskip] ${}^{}$
	\\[\baselineskip]
}
\date[21/05/2020]{21 de mayo de 2020}
...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			pero es claramente inútil cuando deseamos comunicarnos con una computadora.\pause
			\item[$\circ$] Debemos 	re\-pre\-sen\-tar el grafo mediante cierta clase de lista o tabla.
		\end{itemize}
		\vskip .4cm\pause
		\begin{definicion}
	...
	\begin{frame}
		...
		\begin{solucion}
			Primero  dibujemos el grafo para darnos cuenta de por que se llama "rueda". Didujemos $W_6$:\pause
			\vskip .2cm
			\begin{figure}
