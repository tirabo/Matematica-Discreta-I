...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		Si $v$ vértice del grafo con valencia $\delta(v)=k$, por definición de grafo complemento la valencia de $v$ en el grafo complemento es $n-1 -k$. Por lo tanto si denotamos $\delta'(v)$ la valencia de $v$ en el grafo complemento, la respuesta del ejercicio es $\delta' (v_i)=n-1-d_i \;\;\forall\,\; i=1,\dots , n\,$.
	\end{enumerate}
	...
	\item Un ratón intenta comer un $3\times 3\times 3$ cubo de queso. Él comienza en una esquina y come un subcubo de $1\times 1\times 1$, para luego pasar a un subcubo adyacente. ¿Podrá el ratón terminar de comer el queso en el centro?
	 \rta Podemos modelar este problema con un cubo subdividido en 2 en cada dimensión, o también como un grafo en el espacio con coordenadas $(x,y,z)$ con $0 \le x,y,z \le 2$. El grafo sería como en el siguiente dibujo, donde el vértice de partida está en gris y el vértice de llegada en negro. 
	 \begin{center}
