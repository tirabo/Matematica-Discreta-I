...
\begin{observacion}(*) Escribiremos en pseudocódigo el algoritmo para hallar una caminata euleriana. Partimos de un grafo $G$ con $n$ vértices tal que o bien
\begin{enumerate}[a)]
	\item todos los vértices son de valencia par, o bien
	
	\item  solo hay dos vértices de valencia impar. 
\end{enumerate}	
Tomamos como comienzo del recorrido a un vértice arbitrario $v$, con la restricción en el caso (b) de que $\delta(v)$ sea  impar.  
