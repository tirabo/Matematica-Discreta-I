...
\begin{ejercicio}
	\begin{enumerate}
		\item[1.] (50 pts) Encontrar el resto de dividir $9^{52}\cdot 7^{33}$ por $8$.
		\item[2.]  (50 pts)  Probar\textbf{ usando congruencias} que todo número de la forma $3^{2n}-2^n$ es divisible por $7$. 
	\end{enumerate}
\end{ejercicio}
