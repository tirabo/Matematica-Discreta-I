...
\date[07/04/2020]{7 de abril  de 2020}
...
%\frame{\frametitle{Ãndice}\tableofcontents} 
...
\begin{frame}
	...
	Â¿Cuántas palabras de dos letras hay? (26 letras,  no importa si tienen significado)
	\pause
...
\vskip .2cm
 ...
 Sea  $X = \{ 1, 2, 3 \}$.
 \vskip .2cm
 Â¿De cuántas formas se pueden elegir dos de estos números en forma ordenada?
	\vskip .2cm
...
Entonces, las posibilidades son 
	...
	Es decir, hay $9 = 3^2$ formas posibles. 
	 ...
	 \vskip .2cm Â¿Cómo justificamos esto? \pause Por el principio de multiplicación
...
%\begin{ejemplo}
	...
	{\color{blue} Ejemplo}
	\vskip .2cm
	Â¿Cuántos números de cuatro dígitos pueden formarse con
...
{\color{blue} Ejemplo}
\vskip .2cm
	Â¿Cuántos números de $5$ dígitos y capicúas pueden formarse
...
\begin{frame}
		...
		{\color{blue} Ejemplo}
		\vskip .2cm
Sea $X$ un conjunto de $n$ elementos. Â¿Cuántos subconjuntos tiene este conjunto?
\vskip .2cm
